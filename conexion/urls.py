...
urlpatterns = [
    ...
    url(r"^enviarComandoCMD2/", views.enviarComandoCMDGET, name="enviarComandoCMDGET"),
    url(
        r"^enviarComandoCMD3/", views.enviarComandoCMDPOST, name="enviarComandoCMDPOST"
    ),
    ...
    url(
        r"^getDatosImpresora8E/", views.getDatosImpresora8E, name="getDatosImpresora8E"
    ),
    url(
        r"^getDatosImpresora8P/", views.getDatosImpresora8P, name="getDatosImpresora8P"
    ),
]
